        ...
        <div className="mt-14 grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
          <Reveal delay={0.05}>
            <p className="porto-body max-w-xl text-white">
              Jaxpat is a Chennai-based, product-based engineering company helping
              ...
              with RAG, blockchain and Web3 where it fits, cloud APIs, MongoDB
              Atlas/Supabase data layers, and production-ready VR/AR experiences.
            </p>
          </Reveal>
          <Reveal delay={0.1}>
